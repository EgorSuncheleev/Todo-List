  ...
  return (
    <div className="todo__newnote">
      ...
      <div className="todo__newnote-bottom">
        <button className="todo__newnote-button button-cancel">Cancel</button>
        <button className="todo__newnote-button button-apply">Apply</button>
      </div>
    </div>
  );
};

export default NewNoteTask;
